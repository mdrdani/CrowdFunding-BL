...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BlogItem: function BlogItem() {
      return __webpack_require__.e(/*! import() */ 10).then(__webpack_require__.bind(null, /*! ../components/BlogItem */ "./resources/js/components/BlogItem.vue"));
    }
  },
  ...
  methods: {
    go: function go() {
      ...
      axios.get(url).then(function (response) {
        ...
        _this.blogs = data.blog.data;
        _this.page = data.blog.current_page;
        _this.lengthPage = data.blog.last_page;
